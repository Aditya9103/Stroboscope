...
const certificationsFaqData = [
  ...
  },
  {
    ...
    answer:
    "Our quality control process includes continuous dimensional checks, circuit inspection, and flash timing accuracy analysis to ensure flawless Stroboscopes.",
  },
  {
