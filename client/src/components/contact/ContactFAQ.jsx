...
const contactFaqData = [
  ...
  },
  {
    ...
    answer:
    "Yes, we provide comprehensive technical support. Whether you need help selecting the right stroboscope model, troubleshooting a machine defect, or optimizing inspection conditions, our experts are just a phone call or email away.",
  },
  {
    question: "Can I request product samples before placing a bulk order?",
    answer:
    "Absolutely. We understand the importance of testing products in your specific printing environment. Contact our sales team to discuss seeing the stroboscope in action for your press specifications.",
  },
  {
